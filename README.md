...
[![Russian](https://img.shields.io/badge/Language-Russian-red)](https://github.com/Belen/wow-addon-playerbot-ru)
[![Localization](https://img.shields.io/badge/Localization-ruRU-brightgreen)](https://github.com/Belen/wow-addon-playerbot-ru)
...
**Автор локализации:** [Belen](https://github.com/Belen)

**Оригинальный репозиторий:** [whipowill/wow-addon-playerbot](https://github.com/whipowill/wow-addon-playerbot)

## Install / Установка

**Для русской версии:**  
Download this repository as [zip](https://github.com/Belen/wow-addon-playerbot-ru/archive/main.zip) and extract into your ``C:\\Games\WoW\Interface\Addons\PlayerBots`` directory.

**For original version:**  
Download from [original repository](https://github.com/whipowill/wow-addon-playerbot/archive/master.zip).
...
- **Russian (ruRU)** - Added by Belen007
...
**Contributors:**
- Belen007 - Russian (ruRU) localization
...
- [Original Repository](https://github.com/whipowill/wow-addon-playerbot)# PlayerBots Addon - Russian Version 🇷🇺

> **Русская версия аддона PlayerBots с полной локализацией интерфейса**  
> **Russian version of PlayerBots addon with complete interface localization**

[![Russian](https://img.shields.io/badge/Language-Russian-red)](https://github.com/Belen007/wow-addon-playerbot-ru)
[![Localization](https://img.shields.io/badge/Localization-ruRU-brightgreen)](https://github.com/Belen007/wow-addon-playerbot-ru)
...
**Автор локализации:** [Belen](https://github.com/Belen007)
...
**Contributors:**
- Belen - Russian (ruRU) localization
...
- [ike3's Addon Package](https://github.com/ike3/mangosbot-addon)
- [ike3's Instructions](http://ike3.github.io/mangosbot-docs/)
- [Original Repository](https://github.com/whipowill/wow-addon-playerbot)
